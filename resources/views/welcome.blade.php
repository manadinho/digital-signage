    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3">Digital Signage <sup></sup></div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Digital Signage 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
...
//        images_upload_base_path: 'http://localhost/perfume-and-makeup-laravel/public/admin',
            // images_upload_url: "http://localhost/perfume-and-makeup-laravel/public/en/admin/save-image",
//            templates: [
